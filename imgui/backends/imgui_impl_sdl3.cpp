...
bool ImGui_ImplSDL3_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        case SDL_EVENT_KEY_UP:
        {
            ...
            io.SetKeyEventNativeData(key, event->key.keysym.sym, event->key.keysym.scancode, -1); // To support legacy indexing (<1.87 user code). Legacy backend uses SDLK_*** as indices to IsKeyXXX() functions.
            return true;
        }
